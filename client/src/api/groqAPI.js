...
export async function translateSolution({ code, fromLanguage, toLanguage, question_text }) {
  const res = await axios.post('/api/groq/translate-solution', { code, fromLanguage, toLanguage, question_text });
...
export async function fixSolution({ code, language, question_text, failures, header, footer }) {
  const res = await axios.post('/api/groq/fix-solution', { code, language, question_text, failures, header, footer });
  return res.data; // { ok, code, model }
}
...
export async function translateFragment({ code, fromLanguage, toLanguage, kind }) {
  const res = await axios.post('/api/groq/translate-fragment', { code, fromLanguage, toLanguage, kind });
  return res.data; // { ok, code, model }
}
...
export async function translateStub({ codeStub, originalSolution, translatedSolution, fromLanguage, toLanguage, question_text }) {
  const res = await axios.post('/api/groq/translate-stub', { codeStub, originalSolution, translatedSolution, fromLanguage, toLanguage, question_text });
  return res.data; // { ok, code, model }
}
